...
from utils.hex_map_action_ver1 import hex_map
from code.evaluation.simulator import simulator
...
if __name__ == "__main__":
    ...
    s_quote = f"{algo}_ver_hex_map6v1_{period}_lr{lr}_epi{episodes}_prob{prob_dist}_lb{lambda1}_epsilon_decay{epsilon_decay}-{N}"
    ...
    env = MobileChargingEnvironment(HEX, FCS, MCS, starttime, endtime, time_step, f_dir, f_name, lambda1, prob_dist, prob_wait, num_actions=K)
